...
<head>
    ...
    <style>
        ...
        @media (max-width: 640px) {
            ...
            .library-card { padding: 1.5rem 1rem; }
        }
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-20 pt-32 pb-20 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <div class="w-full max-w-4xl text-center relative z-10">
            ...
            <div class="library-card max-w-2xl mx-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <div class="library-card-content">
                    ...
                    <h2 class="text-4xl font-bold text-white mb-6">📖 Library Hub</h2>
                    <p class="text-gray-200 mb-10 text-xl leading-relaxed">
                        Pilih format dan genre favorit Anda. AI akan membuatkan bacaan unik yang menarik,
                        kemudian uji ingatan dan pemahaman Anda dengan game "Melengkapi Kata" yang seru!
                    </p>
                    ...
                    <form action="{{ route('library.generate_game') }}" method="POST" id="game-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                            <!-- Pilihan Format -->
                            <div>
                                <label for="format" class="block text-left text-lg font-medium text-white mb-4">📄 Pilih Format</label>
                            ...
                            <!-- Pilihan Genre -->
                            <div>
                                <label for="genre" class="block text-left text-lg font-medium text-white mb-4">🎨 Pilih Genre/Tema</label>
