    ...
    <main class="relative z-20 pt-32 pb-20 min-h-screen px-4">
        <div class="container mx-auto max-w-4xl">
            ...
            <div class="text-center mb-8" data-aos="fade-down">
                ...
                <h1 class="literise-title mb-4">Misi Membaca</h1>
                <h2 class="text-2xl md:text-3xl font-bold text-white mb-2">{{ $mission['title'] }}</h2>
                <p class="text-gray-300 text-lg">Baca teks dengan seksama dan jawab pertanyaan kuis</p>
            </div>
            ...
            <div class="mission-card" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="mb-10">
                    <div class="flex items-center mb-6">
                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-[#7443ff] to-[#d3a2ff] flex items-center justify-center shadow-lg mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                        </div>
                        <h2 class="text-2xl font-bold text-white">Silakan Baca Teks Berikut</h2>
                    </div>
                ...
                <div class="border-t border-white/20 pt-10">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-white">Kuis Pemahaman</h2>
                    </div>
                    ...
                    <form action="{{ route('game.submit_quiz', $mission['mission_id']) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            @if (isset($mission['quiz_questions']) && is_array($mission['quiz_questions']))
                                @foreach ($mission['quiz_questions'] as $index => $quiz)
                                    <div class="quiz-section" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                                        <label for="answer_{{ $index }}" class="block text-lg font-semibold text-white mb-4">
                            ...
                            <div class="text-center mt-8" data-aos="fade-up" data-aos-delay="300">
                                <button type="submit" class="submit-button w-full md:w-auto px-8">
                                    📝 Kirim Jawaban Kuis
                                </button>
                            </div>
                        </div>
